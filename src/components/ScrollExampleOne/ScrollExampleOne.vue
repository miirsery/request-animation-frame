...
import SmoothScroll from "../shared/SmoothScroll/SmoothScroll.vue";
...
const tick = (scroll) => {
	Object.entries(elements).forEach((element) => {
		...
		element[1].style.transform = `perspective(1000px) rotateY(0) rotateX(${((amount) * Math.PI)/180}deg) scale3d(1, 1, 1)`;
	});
}
